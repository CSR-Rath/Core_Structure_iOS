...
class CustomTabBarVC: UITabBarController {
    ...
    lazy var collactionView: UICollectionView = {
        ...
        collection.register(CustomTabBarCell.self,
                            forCellWithReuseIdentifier: CustomTabBarCell.identifier)
        return collection
    }()
...
extension CustomTabBarVC:  UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    private func setupConstrainAndController(){
