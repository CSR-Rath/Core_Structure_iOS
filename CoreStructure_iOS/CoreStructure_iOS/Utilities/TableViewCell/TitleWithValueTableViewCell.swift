...
//    lazy var dashTwo = DashedLineView()
...
//        dashTwo.isHidden = true
//        dashTwo.lineColor = .E_0_E_0_E_0
//        dashTwo.translatesAutoresizingMaskIntoConstraints = false
//        addSubview(dashTwo)
...
//            dashTwo.heightAnchor.constraint(equalToConstant: 1),
//            dashTwo.centerYAnchor.constraint(equalTo: centerYAnchor, constant: 0),
//            dashTwo.leftAnchor.constraint(equalTo: leftAnchor, constant: 15),
//            dashTwo.rightAnchor.constraint(equalTo: rightAnchor, constant: -15),
        ])
    }
}
