...
extension UICollectionView{
    ...
    func setupRefreshControl() {
        UICollectionView.refresh.tintColor = .blue
        UICollectionView.refresh.addTarget(self, action: #selector(refreshData), for: .valueChanged)
        self.refreshControl = UICollectionView.refresh
    }
    
    
    @objc private func refreshData(){
        UICollectionView.actionRefresh?()
    }
    
    func endRefreshData(){
        UICollectionView.refresh.endRefreshing()
    }
}
