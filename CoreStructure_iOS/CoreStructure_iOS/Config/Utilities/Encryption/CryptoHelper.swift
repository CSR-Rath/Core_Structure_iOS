...
class CryptoHelper{
    ...
    func encrypt(jsonString: String,
                       key256: String,
    ...
    func hmacSHA512(sequence: String, key: String) -> String {
...
class HowToUseCryptoHelper {
    ...
    func useEncryptionAES() {
        ...
        let encrypted = CryptoHelper.shared.encrypt(jsonString: jsonString,
    ...
    func useDecryptionAES(encryptedString: String) {
        let decrypted = CryptoHelper.shared.decrypt(value: encryptedString,
                                                key256: CryptoConfig.Auth.key,
                                                vector: CryptoConfig.Auth.iv)
    ...
    func generateTransferPayload(from request: TransferRequest) -> String {
        ...
        let hash = CryptoHelper.shared.hmacSHA512(sequence: sequence, key: CryptoConfig.Transfer.key)
